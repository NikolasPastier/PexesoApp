...
export function DeckGallery() {
  ...
  const loadDecks = async () => {
    ...
    try {
      ...
      if (filterCardCount !== "all") params.append("card_count", filterCardCount)
  ...
  const handleSelectDeckInline = (deck: Deck) => {
    ...
    <>
      <div className="relative">
        ...
        <div className="relative w-full max-w-7xl mx-auto p-4 sm:p-8">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              <div className="flex items-center gap-2">
                ...
                <Select value={sortBy} onValueChange={handleSortChange}>
                  <SelectTrigger className="w-auto min-w-[140px] bg-gray-700/50 border-gray-600/30 text-white focus:border-primary/50">
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="flex items-center gap-2">
                <span className="text-sm text-gray-300 max-sm:hidden">{t("cards")}:</span>
                <Select value={filterCardCount} onValueChange={handleCardCountChange}>
                  <SelectTrigger className="w-auto min-w-[100px] bg-gray-700/50 border-gray-600/30 text-white focus:border-primary/50">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent className="bg-gray-800 border-gray-600/30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {decks.slice(0, displayCount).map((deck, index) => (
                            ...
                            <div className="flex justify-end gap-2 p-4 border-t border-gray-600/30">
                              <Button
                                onClick={() => {
                                  ...
                                  handleSelectDeckInline(selectedDeck!)
                                }}
          ...
          {decks.length > displayCount && (
            <div className="flex justify-center mt-8">
              <Button
                onClick={handleShowMore}
                className="bg-gray-800 hover:bg-gray-700 text-white border border-gray-600/30 px-8 py-3 rounded-lg font-semibold transition-colors"
              >
                {t("showMore")}
              </Button>
            </div>
